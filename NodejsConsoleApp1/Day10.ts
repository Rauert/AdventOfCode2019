...
var q1a: number[] = Array.from(q1).sort(sortArray);
var q2a: number[] = Array.from(q2).sort(sortArray).reverse();
var q3a: number[] = Array.from(q3).sort(sortArray);
var q4a: number[] = Array.from(q4).sort(sortArray).reverse();
