...
function calcD5(id: number) {
    ...
    var pos: number = 0;
    var opCode: number[] = calcOpCode(input[0]);
    ...
    while (opCode[0] != 99) {
        ...
        opCode = calcOpCode(input[pos]);
    }
}

function calcOpCode(opCodeFull: number): number[] {
